...
// avr
	...
	*/
	...
	#define BTN_UP_PIN_IN PINC		// bemenet olvas�shoz 
	...
	#define BTN_COMMON_PIN_IN PINC // csak ha az �sszes gomb  egy porton van 	
	...
	*/
	...
	//pcint valid mask--> amiket haszn�lhatok 
	#define PCMSK0_VALID_MASK  0b00111111  // PB0�PB5, ha XTAL1/2-t nem haszn�lod
	...
	//	timer config param�terek, van m�g mit fejleszteni- b�v�teni rajtuk --> v0

	// Timer0 m�dok (TCCR0A �rt�kek)
	...
	// Prescaler be�ll�t�sok (TCCR0B CS02:0 �rt�kek)
	...
	// rel� 
	#define RELAY_PORT PORTB		// --> 9 L�B -- PB1
